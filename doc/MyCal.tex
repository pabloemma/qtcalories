...
\item Currently it looks like the UPDATE actually deletes the record. This might have to do with my do\_sql changes. Need backup of psql table. actually it does not delete it but also not update it. again this might be my do\_sql.
